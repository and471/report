...
\begin{figure}[ht]
  \centering
    \includegraphics[width = 0.99\textwidth]{./projman/scrum.jpg}
...
\begin{figure}[ht]
  \centering
    \includegraphics[width = 0.99\textwidth]{./impl/devtools.pdf}
  \caption{Development methods and tools utilised in project.}
  \label{fig:impl_devtools}
\end{figure}
...
Everyone with experience in git
Again cross platform
Commit messages used in conjunction with communicating to each other
Short branch life for features
